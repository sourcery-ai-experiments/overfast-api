...
from app.utils.helpers import blizzard_response_error_from_request, overfast_request


class BlizzardPageParser(BaseParser):
    """Abstract Blizzard Page Parser class used to define generic behavior for
    parsers used to extract data from Blizzard HTML pages.
    The blizzard URL call is handled here.
    """
    ...
    def get_blizzard_url(self, **kwargs) -> str:
        ...
        of root url and query data (kwargs) if the DataResolver supports it.
