...
from app.api.exceptions import ParserParsingError, SearchDataRetrievalError
from app.commands.update_search_data_cache import retrieve_search_data
from app.config import settings
from app.parsers.html.blizzard_page_parser import BlizzardPageParser
...
class SearchDataParser(BlizzardPageParser, ABC):
