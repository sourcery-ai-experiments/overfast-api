...
from app.utils.helpers import routes_responses as common_routes_responses
from app.handlers.get_player_career_request_handler import GetPlayerCareerDataResolver
from app.handlers.get_player_career_stats_request_handler import (
    GetPlayerCareerStatsDataResolver,
)
from app.handlers.get_player_stats_summary_request_handler import (
    GetPlayerStatsSummaryDataResolver,
)
from app.handlers.search_players_request_handler import SearchPlayersDataResolver
...
async def search_players(
    ...
    return await SearchPlayersDataResolver(request).process_query(
        name=name,
        order_by=order_by,
        offset=offset,
        limit=limit,
...
async def get_player_summary(
    ...
    return await GetPlayerCareerDataResolver(request).process_query(
        summary=True,
        player_id=commons.get("player_id"),
    )
...
async def get_player_stats_summary(
    ...
    return await GetPlayerStatsSummaryDataResolver(request).process_query(
        player_id=commons.get("player_id"),
        platform=platform,
        gamemode=gamemode,
    )
...
async def get_player_career_stats(
    ...
    return await GetPlayerCareerStatsDataResolver(request).process_query(
        stats=True,
        **commons,
    )
