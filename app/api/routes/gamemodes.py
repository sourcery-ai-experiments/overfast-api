...
from app.utils.enums import RouteTag
from app.utils.helpers import routes_responses
from app.handlers.list_gamemodes_request_handler import ListGamemodesDataResolver
...
async def list_map_gamemodes(request: Request) -> list[GamemodeDetails]:
    return await ListGamemodesDataResolver(request).process_query()
